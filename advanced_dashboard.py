...
# Create the header with title, logo, and description
header = dbc.Card(
    dbc.CardBody([
        dbc.Row([
            dbc.Col([
                html.Div([
                    ...
                    html.H4("Enterprise Analytics Platform", 
        ...
        dbc.Row([
            dbc.Col([
                html.P(
                    "Sophisticated analytics platform for analyzing the relationship between interest rates and revenue "
                    "with advanced time lag analysis, statistical modeling, and predictive correlation metrics.",
                    className="lead"
                ),
            ], md=8),
            dbc.Col([
                html.Div([
                    dbc.Badge("Advanced Analytics", color="primary", className="me-2 mb-2 p-2"),
                    dbc.Badge("Statistical Models", color="secondary", className="me-2 mb-2 p-2"),
                    dbc.Badge("Time Series Analysis", color="info", className="me-2 mb-2 p-2"),
                ], className="text-end"),
            ], md=4),
        ])
    ]),
...
dashboard_layout = html.Div([
    ...
    dbc.Navbar(
        dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.Span("IR Analytics", className="h3 text-light font-weight-bold")
                ], width="auto"),
                dbc.Col([
                    html.Span("Enterprise Version", className="text-light opacity-75 ms-2")
                ], width="auto"),
            ], className="g-0"),
            ...
            dbc.Collapse(
                dbc.Row([
                    dbc.NavItem(dbc.NavLink("Dashboard", href="#", active=True, className="px-3")),
                    dbc.NavItem(dbc.NavLink("Reports", href="#", className="px-3")),
                    dbc.NavItem(dbc.NavLink("Settings", href="#", className="px-3")),
                    dbc.NavItem(dbc.Button("Export Data", color="light", outline=True, size="sm", className="ms-2")),
                ],
                className="ms-auto g-0 align-items-center"),
                id="navbar-collapse",
                navbar=True,
            ),
        ], fluid=True),
